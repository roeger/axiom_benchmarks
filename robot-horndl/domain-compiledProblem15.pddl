...
(:derived (DATALOG_INCONSISTENT)
          (or (exists (?y0) (AUX0 ?y0)) (exists (?y0) (AUX1 ?y0)) (exists (?y0) (AUX10 ?y0)) (exists (?y0) (AUX11 ?y0)) (exists (?y0) (AUX12 ?y0)) (exists (?y0) (AUX13 ?y0)) (exists (?y0) (AUX14 ?y0)) (exists (?y0) (AUX15 ?y0)) (exists (?y0) (AUX16 ?y0)) (exists (?y0) (AUX17 ?y0)) (exists (?y0) (AUX18 ?y0)) (exists (?y0) (AUX19 ?y0)) (exists (?y0) (AUX2 ?y0)) (exists (?y0) (AUX20 ?y0)) (exists (?y0) (AUX21 ?y0)) (exists (?y0) (AUX22 ?y0)) (exists (?y0) (AUX23 ?y0)) (exists (?y0) (AUX24 ?y0)) (exists (?y0) (AUX25 ?y0)) (exists (?y0) (AUX26 ?y0)) (exists (?y0) (AUX27 ?y0)) (exists (?y0) (AUX3 ?y0)) (exists (?y0) (AUX4 ?y0)) (exists (?y0) (AUX5 ?y0)) (exists (?y0) (AUX6 ?y0)) (exists (?y0) (AUX7 ?y0)) (exists (?y0) (AUX8 ?y0)) (exists (?y0) (AUX9 ?y0))))
