...
(:derived (DATALOG_HORINLINE ?x0 ?x1)
          (or (exists (?y0) (AUX0 ?y0 ?x0 ?x1)) (DATALOG_HORINLINE ?x1 ?x0) (horinline ?x0 ?x1)))
(:derived (DATALOG_RIGHTDIAGONAL ?x0 ?x1)
          (or (exists (?y0) (AUX1 ?y0 ?x0 ?x1)) (DATALOG_RIGHTDIAGONAL ?x1 ?x0) (rightdiagonal ?x0 ?x1)))
...
(:derived (DATALOG_VERINLINE ?x0 ?x1)
          (or (exists (?y0) (AUX2 ?y0 ?x0 ?x1)) (DATALOG_VERINLINE ?x1 ?x0) (verinline ?x0 ?x1)))
