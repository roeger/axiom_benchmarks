...
(:derived (DATALOG_BACKDIAGONAL ?x0 ?x1)
          (or (exists (?y0) (AUX0 ?x0 ?x1 ?y0)) (DATALOG_BACKDIAGONAL ?x1 ?x0) (backdiagonal ?x0 ?x1)))
...
(:derived (DATALOG_VERINLINE ?x0 ?x1)
          (or (exists (?y0) (AUX1 ?x0 ?x1 ?y0)) (DATALOG_VERINLINE ?x1 ?x0) (verinline ?x0 ?x1)))
(:derived (DATALOG_FIGURE ?x0)
          (or (figure ?x0) (queen ?x0)))
(:derived (DATALOG_HORINLINE ?x0 ?x1)
          (or (exists (?y0) (AUX2 ?x0 ?x1 ?y0)) (DATALOG_HORINLINE ?x1 ?x0) (horinline ?x0 ?x1)))
(:derived (DATALOG_RIGHTDIAGONAL ?x0 ?x1)
          (or (exists (?y0) (AUX3 ?x0 ?x1 ?y0)) (DATALOG_RIGHTDIAGONAL ?x1 ?x0) (rightdiagonal ?x0 ?x1)))
